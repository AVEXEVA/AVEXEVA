...
/*******************object******************/
if(!class_exists('object_strike_pad')){
	class iot_strike_pad extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Strike_Pad';
		...
		//Meta
		protected $singular    = 'strike_pad';
		protected $plural			= 'strike_pads';
		//Relationships
