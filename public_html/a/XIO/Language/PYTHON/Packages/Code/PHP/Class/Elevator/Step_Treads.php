...
/*******************object******************/
if(!class_exists('object_step_treads')){
	class iot_step_treads extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Step_Treads';
		...
		//Meta
		protected $singular    = 'step_treads';
		protected $plural			= 'step_treadss';
		//Relationships
