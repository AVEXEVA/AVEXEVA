...
/*******************object******************/
if(!class_exists('object_door_sensor')){
	class iot_door_sensor extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Door_Sensor';
		...
		//Meta
		protected $singular    = 'door_sensor';
		protected $plural			= 'door_sensors';
		//Relationships
