...
/*******************object******************/
if(!class_exists('object_drive_gear')){
	class iot_drive_gear extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Drive_Gear';
		...
		//Meta
		protected $singular    = 'drive_gear';
		protected $plural			= 'drive_gears';
		//Relationships
