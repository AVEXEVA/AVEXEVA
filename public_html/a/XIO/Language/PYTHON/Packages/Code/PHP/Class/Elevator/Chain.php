...
/*******************object******************/
if(!class_exists('object_drive_chain')){
	class iot_drive_chain extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Drive_Chain';
		...
		//Meta
		protected $singular    = 'drive_chain';
		protected $plural			= 'drive_chains';
		//Relationships
