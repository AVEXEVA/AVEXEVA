...
/*******************object******************/
if(!class_exists('object_brake_switch')){
	class iot_brake_switch extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Brake_Switch';
		...
		//Meta
		protected $singular    = 'brake_switch';
		protected $plural			= 'brake_switchs';
		//Relationships
