...
/*******************object******************/
if(!class_exists('object_newell_wheel')){
	class iot_newell_wheel extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Newell_Wheel';
		...
		//Meta
		protected $singular    = 'newell_wheel';
		protected $plural			= 'newell_wheels';
		//Relationships
