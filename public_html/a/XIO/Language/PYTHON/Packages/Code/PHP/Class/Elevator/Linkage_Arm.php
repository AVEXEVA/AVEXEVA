...
/*******************object******************/
if(!class_exists('object_linkage_arm')){
	class iot_linkage_arm extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Linkage_Arm';
		...
		//Meta
		protected $singular    = 'linkage_arm';
		protected $plural			= 'linkage_arms';
		//Relationships
