...
/*******************object******************/
if(!class_exists('object_guide_shoe')){
	class iot_guide_shoe extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Guide_Shoe';
		...
		//Meta
		protected $singular    = 'guide_shoe';
		protected $plural			= 'guide_shoes';
		//Relationships
