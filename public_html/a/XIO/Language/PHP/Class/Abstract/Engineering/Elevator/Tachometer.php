...
/*******************object******************/
if(!class_exists('object_tachometer')){
	class iot_tachometer extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Tachometer';
		...
		//Meta
		protected $singular    = 'tachometer';
		protected $plural			= 'tachometers';
		//Relationships
