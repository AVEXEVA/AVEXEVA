...
/*******************object******************/
if(!class_exists('object_oil_strainer')){
	class iot_oil_strainer extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Oil_Strainer';
		...
		//Meta
		protected $singular    = 'oil_strainer';
		protected $plural			= 'oil_strainers';
		//Relationships
