...
/*******************object******************/
if(!class_exists('object_decmarcation')){
	class iot_decmarcation extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Decmarcation';
		...
		//Meta
		protected $singular    = 'decmarcation';
		protected $plural			= 'decmarcations';
		//Relationships
