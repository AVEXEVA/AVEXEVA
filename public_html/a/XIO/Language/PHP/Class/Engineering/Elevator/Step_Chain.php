...
/*******************object******************/
if(!class_exists('object_step_chain')){
	class iot_step_chain extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Step_Chain';
		...
		//Meta
		protected $singular    = 'step_chain';
		protected $plural			= 'step_chains';
		//Relationships
