...
/*******************object******************/
if(!class_exists('object_chain_guide')){
	class iot_chain_guide extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Chain_Guide';
		...
		//Meta
		protected $singular    = 'chain_guide';
		protected $plural			= 'chain_guides';
		//Relationships
