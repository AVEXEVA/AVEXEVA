...
/*******************object******************/
if(!class_exists('object_rope_gripper')){
	class iot_rope_gripper extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Rope_Gripper';
		...
		//Meta
		protected $singular    = 'rope_gripper';
		protected $plural			= 'rope_grippers';
		//Relationships
