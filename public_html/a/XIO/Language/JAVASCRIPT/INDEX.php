...
IF( file_exists( '../JAVASCRIPT/PAGE/' . substr( $_SERVER['SCRIPT_NAME'], 0, strlen( $_SERVER['SCRIPT_NAME'] ) - 4 ) . '/INDEX.php') ){
  REQUIRE( '../JAVASCRIPT/PAGE/' . substr( $_SERVER['SCRIPT_NAME'], 0, strlen( $_SERVER['SCRIPT_NAME'] ) - 4 ) . '/INDEX.php' );
}?>
