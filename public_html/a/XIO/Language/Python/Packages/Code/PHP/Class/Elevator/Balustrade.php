...
/*******************object******************/
if(!class_exists('object_balustrade')){
	class iot_balustrade extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Balustrade';
		...
		//Meta
		protected $singular    = 'balustrade';
		protected $plural			= 'balustrades';
		//Relationships
