...
/*******************object******************/
if(!class_exists('object_commutator')){
	class iot_commutator extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Commutator';
		...
		//Meta
		protected $singular    = 'commutator';
		protected $plural			= 'commutators';
		//Relationships
