...
array_shift($csv);
?>
<div class='card' rel='5'>
  <div class='card-header'>$25 Box 'o Chocolates</div>
  <img class='card-image-top' src='media/chocolates.jpg' width='100%' />
  <div class='card-body'>Ferrero Rocher Collection, Fine Hazelnut Milk Chocolates, 48 Count, Christmas Gift Box, Assorted Coconut Candy and Chocolates, Perfect Stocking Stuffers</div>
  <div class='card-footer'>
    ...
    if(count($csv) > 0 && $check){foreach($csv as $row){
      if($row['Gift'] == 5 && $row['Person'] == $_SESSION['Person']){?>
        <div class='row'>
