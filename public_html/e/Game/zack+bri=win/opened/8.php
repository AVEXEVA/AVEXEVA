...
array_shift($csv);
?>
<div class='card' rel='8'>
  <div class='card-header'>$18 6 Pack of Tupperware</div>
  <img class='card-image-top' src='media/tupperware.jpg' width='100%' />
  <div class='card-body'>Tupperware! YAY! </div>
  <div class='card-footer'>
    ...
    if(count($csv) > 0 && $check){foreach($csv as $row){
      if($row['Gift'] == 8 && $row['Person'] == $_SESSION['Person']){?>
        <div class='row'>
