...
/*******************object******************/
if(!class_exists('object_hall_lantern')){
	class iot_hall_lantern extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Hall_Lantern';
		...
		//Meta
		protected $singular    = 'hall_lantern';
		protected $plural			= 'hall_lanterns';
		//Relationships
