...
/*******************object******************/
if(!class_exists('object_valve_coil')){
	class iot_valve_coil extends object {
		/*******************Variables******************/
		//Server
		protected $server      = '172.16.12.44';
		protected $database 		= 'Device';
		//Table
		protected $table 			= 'Valve_Coil';
		...
		//Meta
		protected $singular    = 'valve_coil';
		protected $plural			= 'valve_coils';
		//Relationships
