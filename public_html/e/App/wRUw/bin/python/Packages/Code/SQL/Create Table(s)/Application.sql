...
INSERT INTO Email(Address) VALUES('avex@avexeva.com');
CREATE TABLE Phone (
  ID      INT NOT NULL AUTO_INCREMENT,
  Number  VARCHAR(256)
);
INSERT INTO Phone(Number) VALUES('5162502475');
...
INSERT INTO Address(Name, Room, Floor, Street, City, State, Zip_Code, Country) VALUES('Apartment 613', '613', '6', '4720 Center Boulevard', 'Long Island City', 'New York', '11101', 'United States of America'), ('Nouveau Elevator Industries, Inc. Headquarters', '', '3', '47-55 37th Street', 'Long Island City', 'New York', '11101', 'United States of America');
CREATE TABLE Person (
  ID INT NOT NULL AUTO_INCREMENT,
  Entity INT NOT NULL,
...
INSERT INTO Person(First_Name, Middle_Name, Last_Name, Birthday, Email, Home, Work, Cell, Office) VALUES('Peter', 'Donald', 'Speranza', '1989-05-01 11:59:59.000', 1, 1, 2, 1, 2);
CREATE TABLE User (
  ID        INT NOT NULL AUTO_INCREMENT,
  Name      VARCHAR(256),
