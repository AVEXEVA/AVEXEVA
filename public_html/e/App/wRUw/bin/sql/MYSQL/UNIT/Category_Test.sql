CREATE TABLE [Portal].dbo.[Category_Test](
  ...
  [Unit] int NOT NULL,
  [Fire_Service_Test] bit,
  [Modernization]	bit,
  [General_Comments] varchar(max),
  [Internal_Comments] varchar(max),
  [Witness_Name]	varchar(255),
  [Witness_License] varchar(255),
  [Witness_Date]	datetime,
  [Inspector_Name] varchar(255),
  [Inspector_License] varchar(255),
