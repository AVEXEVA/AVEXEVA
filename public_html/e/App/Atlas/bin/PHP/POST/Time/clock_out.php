...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    if(!isset($array['ID'])){?><html><head></head></html><?php }
      ...
      $r = sqlsrv_query($Portal, "UPDATE Portal.dbo.Attendance SET Attendance.[End] = ?, Attendance.[End_Notes] = ? WHERE Attendance.[User] = ? AND Attendance.[End] IS NULL;",array(date("Y-m-d H:i:s"),$_POST['Notes'],$_SESSION['User']));
