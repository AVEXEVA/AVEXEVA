...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
  ...
  if(!$Privileged || count($_POST) == 0 || !isset($_POST['Latitude'],$_POST['Longitude'],$_POST['Time_Stamp']) || !is_numeric($_POST['Latitude']) || !is_numeric($_POST['Longitude'])){
    ...
    sqlsrv_query($Portal_44,"INSERT INTO Portal.dbo.GPS(Employee_ID, Latitude, Longitude, Altitude, Accuracy, Time_Stamp) VALUES(?, ?, ?, ?, ?, ?);", array($_SESSION['User'], $_POST['Latitude'], $_POST['Longitude'], 0, 0, $_POST['Time_Stamp']));
    sqlsrv_query($Portal_44,"DELETE FROM Portal.dbo.GPS WHERE GPS.Time_Stamp < ?;",array(date("Y-m-d H:i:s",strtotime("-3 days"))));
  }
}?>
