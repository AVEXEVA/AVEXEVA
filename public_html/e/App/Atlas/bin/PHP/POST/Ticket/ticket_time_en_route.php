      ...
      if($r && is_array(sqlsrv_fetch_array($r))){
        ...
        if($r){
          ...
          if(is_array($row)){
            ...
            array($_POST['ID'],  $My_User['fWork'], "En route time", "Updated en route time to " . date("h:i A"), $row['Latitude'], $row['Longitude'], 0, 0, date("Y-m-d H:i:s",strtotime('-5 hours', strtotime($row['Time_Stamp'])))));
          }
        }
