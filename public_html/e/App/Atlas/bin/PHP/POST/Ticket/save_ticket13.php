              ...
              if(isset($row2['ID'])){
                ...
                if($r3){
                  ...
                  while($row3 = sqlsrv_fetch_array($r3)){
                    if($row3['Percentage'] == 0 || $row3['Percentage'] == null){
                      $all_deficiencies_complete = false;
                      break;
                    }
