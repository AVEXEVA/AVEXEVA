...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    if(!isset($Connection['ID']) || !$Privileged){print json_encode(array('data'=>array()));}
			...
			$r = sqlsrv_query($NEI,"
             ...
             Loc.Loc AS Location_ID,
				...
				FROM (SELECT TicketO.ID       AS ID,
						 ...
						 WHERE  (TicketO.DDate >= ? AND TicketO.DDate <= ?) OR TicketO.Assigned = 0
					) AS Tickets
        ...
        WHERE Tickets.Level <> 10
			",array($Start_Date,$End_Date),array("Scrollable"=>SQLSRV_CURSOR_KEYSET));
      ...
      $levels = array(
    	...
    	if($r){
            ...
            if(strrpos($Ticket['Description'], 'Daily Ticket') !== false){continue;}
