...
<?php if(!isset($_GET['popup'])){?><div class='popup Ticket' class='' style='width:900px;font-size:12px !important;background-color:white;color:black !important;height:80% !important;z-index:99;overflow-y:scroll;'><?php }?>
...
<?php if(!isset($_GET['popup'])){?></div><?php }?>
<?php
  }
}
?>
