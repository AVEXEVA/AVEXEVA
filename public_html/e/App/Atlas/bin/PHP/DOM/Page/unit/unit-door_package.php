...
?><!DOCTYPE html>
        ...
        <div class='panel-heading' onclick="someFunction(this,'unit-door_package.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/door_package.png' width='auto' height='35px' /> Door Package</div>
          ...
          <div class='row'><div class='col-xs-12'><button onClick='save_Rope_Gripper();' type='button' style='width:100%;'>Save</button></div></div>
        </div>
        <div class='panel-heading'>Configuration</div>
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-door_package-door_hanger.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/door_hanger.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Door Hanger</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-door_package-buck.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/buck.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Bucks</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-door_package-header.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/header.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Header</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-door_package-doors.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/car_door.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Door(s)</div>
            </div>
          </div>
        </div>
			</div>
