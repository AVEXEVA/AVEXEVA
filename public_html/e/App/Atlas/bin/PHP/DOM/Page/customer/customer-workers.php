...
if(isset($_SESSION['User'],$_SESSION['Hash'])){
    ...
    sqlsrv_query($Portal,"INSERT INTO Activity([User], [Date], [Page]) VALUES(?,?,?);",array($_SESSION['User'],date("Y-m-d H:i:s"), "customer-workers.php"));
...
<div class="panel panel-primary">
			...
			<div class="panel-body white-background BankGothic shadow">
				<table id='Table_People' class='display' cellspacing='0' width='100%' style='font-size:6px;'>
					<thead>
						<th>ID</th>
						<th>First Name</th>
						<th>Last Name</th>
