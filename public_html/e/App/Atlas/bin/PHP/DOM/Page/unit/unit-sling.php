...
?><!DOCTYPE html>
        ...
        <div class='panel-heading' onclick="someFunction(this,'unit-sling.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/sling.png' width='auto' height='35px' /> Sling</div>
				<div class='panel-body' style='margin-top:10px;'><form id='form_Sling'>
          <div class='row'>
          ...
          <div class='row'><div class='col-xs-12'><button onClick='save_Sling();' type='button' style='width:100%;'>Save</button></div></div>
          <div class='row'><div class='col-xs-12'>&nbsp;</div></div>
        </form></div>
        <script>
          function save_Sling(){
            var formElement = document.getElementById('form_Sling');
            var formData = new FormData(formElement);
            formData.append('ID', '<?php echo $_GET['ID'];?>');
            $.ajax({
              url:"cgi-bin/php/post/unit/sling.php",
              data:formData,
              processData: false,
              contentType: false,
              method:"POST",
        ...
        <div class='panel-body'>
          <div class='row'>
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-safety_jaw.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/safety_jaw.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Safety Jaw</div>
            </div>
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-sling-crosshead.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/crosshead.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Crosshead</div>
            </div>
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-sling-post.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/post.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Posts</div>
            </div>
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-sling-platform.php?ID=<?php echo $_GET['ID'];?>');">
