...
?><!DOCTYPE html>
        ...
        <div class='panel-heading' onclick="someFunction(this,'unit-railings.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/railing.png' width='auto' height='35px' /> Guide Railings</div>
          ...
          <div class='row'>
            ...
            <div class='col-xs-8'><select name='Speed'>
              <option value=''>Select</option>
              <option value='Single'>Single</option>
              <option value='Double'>Double</option>
              <option value='Peel-e'>Peel-e</option>
            </select></div>
          </div>
        ...
        <div class='panel-heading'>Configuration</div>
				<div class='panel-body' style='margin-top:10px;'>
          <div class='row'>
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-guide_shoes.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-roller_guides.php?ID=<?php echo $_GET['ID'];?>');">
