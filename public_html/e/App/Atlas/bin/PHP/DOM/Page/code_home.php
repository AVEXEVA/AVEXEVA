...
if(session_id() == '' || !isset($_SESSION)) {
    session_start();
    $_SESSION['page-target'] = 'code_home';
...
?><div class="panel panel-primary" style='height:100%;'>
  ...
  <div class='panel-body'>
    ...
    <div class='row'>
      <div class='col-xs-6' style='border:3px solid black;'><h3> Violation Opportunities</h3></div>
