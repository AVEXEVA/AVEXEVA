...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'  onclick="someFunction(this,'unit-machine-brake.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/brake.png' width='auto' height='35px' /> Machine Brakes</div>
				<div class='panel-body' style='margin-top:10px;'>
          <div class='row'>
            <div class='col-xs-4'>Product:</div>
            <div class='col-xs-8'><input type='text' value='<?php echo isset($Product['Product']) ? $Product['Product'] : '';?>' name='Product' /></div>
          </div>
          <div class='row'>
            <div class='col-xs-4'>Serial:</div>
            <div class='col-xs-8'><input type='text' value='<?php echo isset($Product['Serial']) ? $Product['Serial'] : '';?>' name='Serial' /></div>
          </div>
