...
<div class="panel panel-primary">
  <div class='panel-heading'><img src='media/images/icons/traveler.png' width='auto' height='35px' /> Traveler</div>
    ...
    <div class='row'>
      ...
      <div class='col-xs-8'><input type='text' name='Color' placeholder='Color' value='<?php echo isset($Product['Color']) ? $Product['Color'] : '';?>' /></div>
    </div>
    <div class='row'>
      <div class='col-xs-4'>Composition:</div>
      <div class='col-xs-8'><input type='text' name='Composition' placeholder='Composition' value='<?php echo isset($Product['Composition']) ? $Product['Composition'] : '';?>' /></div>
    </div>
