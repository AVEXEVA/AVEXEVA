...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/floor.png' width='auto' height='25px' /> Nth Floor</div>
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-bank.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/bank.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Bank</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-controller-faults.php?ID=<?php echo $_GET['ID'];?>');">
              ...
              <div class ='nav-text'>Hall Station</div>
            </div>
          ...
          <div class='row'>
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-controller-rectifiers.php?ID=<?php echo $_GET['ID'];?>');">
              ...
              <div class ='nav-text'>Door Track</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-controller-transformers.php?ID=<?php echo $_GET['ID'];?>');">
              ...
              <div class ='nav-text'>Linkage Arm</div>
            </div>
          </div>
          <div class='row'>
