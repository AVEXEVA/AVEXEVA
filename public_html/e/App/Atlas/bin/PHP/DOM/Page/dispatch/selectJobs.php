      ...
      function selectJob(tbl){
        $("table#Table_Jobs tbody tr").each(function(){
          $(this).on('click',function(){
            $('#Dispatch_Job').html($(this).children(':nth-child(1)').html() + ' - ' + $(this).children(':nth-child(2)').html());
            $('#new-dispatch-ticket input[name="Job"]').val($(this).children(':first-child').html());
            $('#selectJobs').remove();
          });
        });
      }
