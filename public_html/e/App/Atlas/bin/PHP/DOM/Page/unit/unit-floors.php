...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'>
          <div class='row'>
            <div class='col-xs-2'><img src='media/images/icons/floor.png' width='auto' height='25px' /></div>
            <div class='col-xs-4'>Floors</div>
            <div class='col-xs-6'><button onClick='add_floor(this);' style='color:black;width:100%;'>Add Floor</button></div>
          </div>
        </div>
        <div class='panel-body'>
            <script>
              function add_floor(link){
                //var floor_name = prompt("What is the floor name?");
                $(".floors").append("<div class='floor col-xs-12 shadower' style='padding:10px;'><div class='row'><div class='col-xs-2'><img src='media/images/icons/floor.png' width='auto' height='25px' /></div><div class='col-xs-8'><input name='Floor_Name' size='20' placeholder='Floor Name' /></div><div class='col-xs-2'><button onClick='save_floor_name(this);'>Save</button></div></div></div>");
              }
              function save_floor_name(link){
                $(link).parent().siblings(".col-xs-8").html($(link).parent().siblings(".col-xs-8").children("input").val()).removeClass('col-xs-8').addClass('col-xs-10').next().remove();
              }
            </script>
