...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/motor.png' width='auto' height='35px' /> Machine Motor</div>
        ...
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-armature.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/armature.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Armature</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-stator.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/stator.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Stator</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-rotor.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/rotor.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Rotor</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-commutator.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/commutator.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Commutator</div>
            </div>
          </div>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-terminals.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/terminal.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Terminals</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-machine-motor-brushes.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/motor_brush.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Brushes</div>
            </div>
          </div>
        </div>
			</div>
