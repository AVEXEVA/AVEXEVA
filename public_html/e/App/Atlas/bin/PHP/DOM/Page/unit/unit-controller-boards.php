...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/board.png' width='auto' height='25px' /> Controller Boards</div>
        <div class='panel-body'>
          <div class='row' id='boards'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="add_board();">
              <div class='nav-icon'><img src='media/images/icons/board.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Add Board</div>
            </div>
          </div>
        </div>
        <script>
          var div_board = "<div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick=\"add_board();\"><div class='nav-icon'><img src='media/images/icons/board.png' width='auto' height='35px' /></div><div class ='nav-text'>Add Board</div></div>";
          function add_board(){
            $('div#boards').append(div_board);
          }
        </script>
			</div>
<?php
