  ...
  <div class='panel-heading'><img src='media/images/icons/traveler.png' width='auto' height='35px' /> Traveler</div>
    ...
    <div class='row'>
      ...
      <div class='col-xs-8'><select name='Type'>
        ...
        <option value='Push Button to Call'>Push Button to Call</option>
        <option value='Push Button to Talk'>Push Button to Talk</option>
      </select></div>
    </div>
    <div class='row'>
      ...
      <div class='col-xs-8'><select name='Type'>
        <option value=''>Select</option>
        <option value='Phone Line'>Phone Line</option>
