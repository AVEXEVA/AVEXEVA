...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/button.png' width='auto' height='25px' /> Car Station Buttons</div>
        <div class='panel-body'>
          <div class='row' id='buttons'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="add_button();">
              <div class='nav-icon'><img src='media/images/icons/button.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Add Button</div>
            </div>
          </div>
        </div>
        <script>
          var div_button = "<div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick=\"add_button();\"><div class='nav-icon'><img src='media/images/icons/button.png' width='auto' height='35px' /></div><div class ='nav-text'>Add Button</div></div>";
          function add_button(){
            $('div#buttons').append(div_button);
          }
        </script>
			</div>
<?php
