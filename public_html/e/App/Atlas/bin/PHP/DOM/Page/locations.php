...
if(session_id() == '' || !isset($_SESSION)) {
    session_start();
    $_SESSION['page-target'] = 'locations';
...
?><div class="panel panel-primary" style='height:100%;'>
  ...
  <div class="panel-body" style='height:90%;background-color:#2a2a2a'>
    <table id='Table_Locations' class='display' cellspacing='0' width='100%' style='font-size:12px;color:white !important;'>
      <thead><tr>
    ...
    var Table_Locations = $('#Table_Locations').DataTable( {
      "processing":true,
      "serverSide":true,
      "ajax": "cgi-bin/php/get/Locations2.php",
      "order": [[ 1, "asc" ]],
      "columns": [
        {
          "className":"hidden",
    ...
    function hrefLocations(){
      $('Table#Table_Locations tr').on('dblclick', function(){
        open_page("<div page-target='location'></div>", {ID:$(this).children(':first-child').html()});
      });
    }
