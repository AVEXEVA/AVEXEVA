...
?><!DOCTYPE html>
        ...
        <div class='panel-heading' onclick="someFunction(this,'unit-door_package-doors.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/car_door.png' width='auto' height='35px' /> Floor Doors</div>
          ...
          <div class='row'>
            ...
            <div class='col-xs-8'><input placeholder='Length' type='text' value='<?php echo isset($Item['Length']) ? $Item['Length'] : '';?>' name='Length' /></div>
          </div>
          <div class='row'>
            <div class='col-xs-4'>Width:</div>
            <div class='col-xs-8'><input placeholder='Width' type='text' value='<?php echo isset($Item['Width']) ? $Item['Width'] : '';?>' name='Width' /></div>
          </div>
          <div class='row'>
            <div class='col-xs-4'>Height:</div>
            <div class='col-xs-8'><input placeholder='Height' type='text' value='<?php echo isset($Item['Height']) ? $Item['Height'] : '';?>' name='Height' /></div>
          </div>
          <div class='row'>
          ...
          <div class='row'>
            ...
            <div class='col-xs-8'><select name='Hand'>
              <option <?php echo !isset($Doors['Hand']) || is_null($Doors['Hand']) ? 'selected' : '';?> value=''>Select</option>
              <option <?php echo isset($Doors['Hand']) && $Doors['Hand'] == 0 ? 'selected' : '';?> value='0'>No</option>
              <option <?php echo isset($Doors['Hand']) && $Doors['Hand'] == 1 ? 'selected' : '';?> value='1'>Yes</option>
            </select></div>
          </div>
          <div class='row'><div class='col-xs-12'>&nbsp;</div></div>
          <div class='row'><div class='col-xs-12'><button onClick='save_Floor_Doors();' type='button' style='width:100%;'>Save</button></div></div>
        </div>
			</div>
<?php
    }
