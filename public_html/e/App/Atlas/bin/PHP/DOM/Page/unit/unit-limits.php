...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/limit.png' width='auto' height='35px' /> Limits</div>
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-lower_final_limit.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/limit.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Lower Final Limit</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-lower_normal_limit.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/limit.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Lower Normal Limit</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-upper_normal_limit.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/limit.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Upper Normal Limit</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-upper_final_limit.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/limit.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Upper Final Limit</div>
            </div>
          </div>
        </div>
			</div>
