...
<div class="panel panel-primary">
  ...
  <div class='panel-body' style='padding:10px;'>
    ...
    <div class='row'>
      <!--<div class='col-xs-4'>&nbsp;</div>
      <div class='col-xs-8'><button style='width:100%;' onClick='add_Deficiency_Resolution(this);'>Add Resolution</button></div>-->
      <div class='col-xs-12'>&nbsp;</div>
  ...
  <div class='panel-body' style='padding:10px;'>
    ...
    <div class='row Resolution-Items'>
      ...
      <div class='col-xs-8'><select name='Resolution_Code' style='width:100%;'>
        <?php 
            $Resolution_Codes = array(
                'Not authorized by building / building closed ',
                'LSD - Left shutdown',
                'FTS - Further troubleshoot',
                'D/T - correct door trouble',
                'M/S - Misuse',
      ...
      <div class='col-xs-12'>&nbsp;</div>
      <div class='col-xs-12'><button onClick='addResolutionCode();' style='width:100%;'>Add Resolution Code</button></div>
      <script>
        function addResolutionCode(){
            if($("#TextareaResolution").val() == ''){
                $("#TextareaResolution").val($("select[name='Resolution_Code']").val());
