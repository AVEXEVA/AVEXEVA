...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="<?php if(isMobile()){?>border-color:#151515 !important;<?php }?>margin-bottom: 0;background-color:#151515;color:white;<?php if(!isMobile()){?>position:fixed;width:100%;<?php }?>">
    <div class="navbar-header">
        <a class="navbar-brand BankGothic" href="index.php" style='font-size:30px;color:white;'>
            <img src='http://www.nouveauelevator.com/Images/Icons/logo.png' width='30px' style='padding-right:5px;' align='left' />
            <?php if(isMobile()){?><span style='font-size:22px;'><?php }?>Nouveau Elevator<?php if(isMobile()){?></span><?php }?>
        </a>
    </div>
	<?php if(!isMobile()){?><div style='float:right;'>version 3.0&nbsp;&nbsp;&nbsp;</div><?php }?>
	<?php if(FALSE && !($My_User['Field'] == 1 && $My_User['Title'] != 'OFFICE' && FALSE) && is_array($My_User)){?><div class='menu-container' style='background-color:#151515;color:white;'>
		<div class='menu'>
			<ul <?php if(!isMobile()){?>style='float:left;width:60%;'<?php }?>>
				...
				<li><a href="#">Reports</a>
                    <ul>
						...
						<li><a href="#">Sales</a>
							<ul>
								<li><a href="http://www.nouveauelevator.com/portal/proposals_for_Mike_Hannan.php"><?php $Icons->Customer();?> <span class=''>Proposals for Mike H.</span></a></li>
							</ul>
						</li>
                        <li><a href="#">Payroll</a>
                            <ul>
				...
				<li><a href="#">Other</a>
					<ul>
						...
						<li><a href="profile.php?ID=<?php echo $My_User['ID'];?>">Profile</a></li>
					</ul>
				</li>
				<li><a href="#">Options</a>
					<ul>
			...
			<?php if(!isMobile() && FALSE){?><form style='height:100%;float:left;width:20%;' action='search.php' method='GET'><input name='Keyword' type='text' size='30' placeholder='Search' style='height:50px;color:black;'/></form><?php }?>
		</div>
	</div><?php } elseif(FALSE) {?><div class='menu-container' style='background-color:#151515;color:white;'>
		<div class='menu'>
			<ul>
				<li><a href="home.php">Dashboard</a></li>
				<li><a href="#">Records</a>
                    <ul>
						<?php if(isset($My_Privileges['Location']) && $My_Privileges['Location']['User_Privilege'] >= 4){?><li><a href="locations.php"><?php $Icons->Location();?> Locations</a></li><?php }?>
						<?php if(isset($My_Privileges['Job']) && $My_Privileges['Job']['User_Privilege'] >= 4){?><li><a href="jobs.php"><?php $Icons->Job();?> Jobs</a></li><?php }?>
						<?php
						$RouteNav = False;
						$r = sqlsrv_query($NEI,"SELECT * FROM Route WHERE Mech=?;",array($My_User['fWork']));
						...
						<?php if(isset($My_Privileges['Ticket']) && $My_Privileges['Ticket']['User_Privilege']){?><li><a href="tickets.php"><?php $Icons->Ticket();?> Tickets</a></li><?php }?>
						<?php if(isset($My_Privileges['Unit']) && $My_Privileges['Unit']['User_Privilege'] >= 4){?><li><a href="units.php"><?php $Icons->Unit();?> Units</a></li><?php }?>
						<?php if(isset($My_Privileges['Violation']) && $My_Privileges['Violation']['User_Privilege']){?><li><a href="violations.php"><?php $Icons->Violation();?> Violations</a></li><?php }?>
                    </ul>
                </li>
				<li><a href="#">Reports</a>
					<ul>
