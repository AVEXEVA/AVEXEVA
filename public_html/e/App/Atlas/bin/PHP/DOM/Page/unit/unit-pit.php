...
?><!DOCTYPE html>
        ...
        <div class='panel-heading' onClick="someFunction(this,'unit-pit.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/pit.png' width='auto' height='35px' /> Pit</div>
        ...
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-buffer.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/buffer.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Car Buffer</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-buffer.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/buffer.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>C.W. Buffer</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-governor-tension_sheave.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/sheave.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Governor Tension Sheave</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-pit-stop_switch.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/stop_switch.png' width='auto' height='35px' /></div>
          ...
          <div clas='row'>
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-pit-lights.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-pit-ladder.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/ladder.png' width='auto' height='35px' /></div>
