...
?><div class="panel panel-primary" style='height:100%;'>
  <div class="panel-heading"><h3><?php $Icons->Login();?> Logins</h3></div>
  <div class="panel-body">
    ...
    <?php if($_GET['Preloaded'] == 1){require('cgi-bin/js/chart/activity.php');} else {require('../../../cgi-bin/js/chart/activity.php');}?>
    <script>
