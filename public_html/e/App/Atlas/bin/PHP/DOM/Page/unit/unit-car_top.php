    ...
    if(!isset($array['ID'])  || !$Privileged || !is_numeric($_GET['ID'])){?><html><head><script>document.location.href="../login.php?Forward=unit<?php echo (!isset($_GET['ID']) || !is_numeric($_GET['ID'])) ? "s.php" : ".php?ID={$_GET['ID']}";?>";</script></head></html><?php }
        ...
        if($r){
          ...
          if($r){
            ...
            $sQuery = "SELECT Counterweight.* FROM Device.dbo.Car_Top WHERE Car_Top.Item = ?";
            $params = array($Item['ID']);
            $r = sqlsrv_query($database_Device, $sQuery, $params);
            if($r){
              $Car_Top = sqlsrv_fetch_array($r);
            }
          }
        }
?><!DOCTYPE html>
			<div class="panel panel-primary">
        <div class='panel-heading'  onclick="someFunction(this,'unit-car_top.php?ID=<?php echo $_GET['ID'];?>');"><img src='media/images/icons/car_top.png' width='auto' height='35px' /> Car Top</div>
				<div class='panel-body' style='margin-top:10px;'><form id='form_Car_Top'>
        ...
        <div class='row'><div class='col-xs-12'><button onClick="save_Car_Top();" type='button' style='width:100%;'>Save</button></div></div>
      </form></div></div>
      <script>
        function save_Car_Top(){
          var formElement = document.getElementById('form_Car_Top');
          var formData = new FormData(formElement);
          formData.append('ID', '<?php echo $_GET['ID'];?>');
          $.ajax({
            url:"cgi-bin/php/post/unit/car_top.php",
            data:formData,
            processData: false,
            contentType: false,
            method:"POST",
        ...
        <div class='panel-body'>
          <div class='row' style='height:75px;'>
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-door_operator.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-selector.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/selector.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Selector</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-traveler.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/traveler.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Traveling Cable</div>
            </div>
          </div>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-guide_shoes.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-roller_guides.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-sling.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/sling.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Sling</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-car_top_station.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/car_top_station.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Car Top Station</div>
            </div>
          </div>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-car_top-shackles.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/shackle.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Shackles</div>
            </div>
          </div>
				</div>
			</div>
