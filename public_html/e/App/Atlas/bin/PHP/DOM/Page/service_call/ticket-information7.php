...
<div class="panel panel-primary">
  ...
  if($A_Latitude != 0 && $A_Longitude != 0 && $M_Latitude != 0 && $M_Longitude != 0){?>
    ...
    <div class='panel-heading' style='padding:1px;padding-left:10px !important;margin:0px;margin-bottom:5px;'><h4><button onClick='renderMap();' style='color:black;'><?php $Icons->Map(1);?> Map / Directions</button></h4></div>
    <div class='panel-body'>
    <div class='row'><div class='col-xs-12' id='DIRECTIONAL_MAP' style='height:300px;display:none;'></div></div>
  </div>
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAJwGnwOrNUvlYnmB5sdJGkXy8CQsTA46g&callback=falsecallback"></script>
  ...
  <div class='panel-body' style='padding:10px;'>
    ...
    <div class='signature row'>
      ...
      <div class='col-xs-8'><input type='text' placeholder='Name of Signaturee' name='Signature_Name' style='width:100%;' value='<?php echo $Ticket2['SignatureText'];?>' /></div>
...
<?php require("../../../../cgi-bin/js/pages/ticket6.php");?>
<style>
