    ...
    <div class="panel-body  BankGothic shadow">
                ...
                <div class="panel-body  BankGothic shadow" style='padding-top:100px;'>
                    <div style='display:block !important;'>
                        <fieldset >
                            ...
                            <?php if(isset($My_Privileges['Finances'])){?><editor-field name='Cost'></editor-field>
                            <editor-field name='Price'></editor-field><?php }?>
                        </fieldset>
                    </div>
                </div>
            </div>
        ...
        <table id='Table_Proposals' class='display' cellspacing='0' width='100%' style='font-size:12px;'>
            <thead>
                ...
                <?php if(isset($My_Privileges['Finances'])){?><?php if($_SESSION['Branch'] != 'Customer'){?><th title="Proposed Cost">Cost</th><?php }?>
                <th title='Proposed Amount'>Price</th><?php }?>
            </thead>
        </table>
    </div>
</div>
...
var Editor_Proposals = new $.fn.dataTable.Editor({
    ...
    fields : [{
        ...
        label:"Title",
        name:"Title"
    }<?php if(isset($My_Privileges['Finances'])){?>,{
        label:"Cost",
        name:"Cost"
    },{
        label:"Price",
