...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/counterweight_frame.png' width='auto' height='25px' /> Counter Weights Properties</div>
        ...
        <div class='panel-body'>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-counter_weight-weights.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/weight.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Weights</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-counter_weight-guide_shoes.php?ID=<?php echo $_GET['ID'];?>');">
            ...
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-counter_weight-roller_guides.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/roller_guides.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Roller Guides</div>
            </div>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-counter_weight-buffer.php?ID=<?php echo $_GET['ID'];?>');">
              <div class='nav-icon'><img src='media/images/icons/relay.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Buffer</div>
            </div>
          </div>
          <div class='row'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="someFunction(this,'unit-counter_weight-cables.php?ID=<?php echo $_GET['ID'];?>');">
