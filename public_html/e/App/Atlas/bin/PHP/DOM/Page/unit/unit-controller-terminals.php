...
?><!DOCTYPE html>
        ...
        <div class='panel-heading'><img src='media/images/icons/terminal.png' width='auto' height='25px' /> Controller Terminals</div>
        <div class='panel-body'>
          <div class='row' id='terminals'>
            <div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick="add_terminal();">
              <div class='nav-icon'><img src='media/images/icons/terminal.png' width='auto' height='35px' /></div>
              <div class ='nav-text'>Add Terminal</div>
            </div>
          </div>
        </div>
        <script>
          var div_terminal = "<div class='Home-Screen-Option col-lg-1 col-md-2 col-xs-3' onclick=\"add_terminal();\"><div class='nav-icon'><img src='media/images/icons/terminal.png' width='auto' height='35px' /></div><div class ='nav-text'>Add Terminal</div></div>";
          function add_terminal(){
            $('div#terminals').append(div_terminal);
          }
        </script>
			</div>
<?php
