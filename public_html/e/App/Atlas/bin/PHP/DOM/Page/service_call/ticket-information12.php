...
<div class="panel panel-primary">
        ...
        if(count($Tasks) > 0){
          foreach($Tasks AS $index=>$Task){
            ...
            foreach($SQL_Tasks_Descriptions as $index2=>$Description) {
              ...
              if((trim($Task) == $Description && ($SQL_Tasks_Percentages[$count2] == '1'))){
                ...
                ?><div class='row' style='background-color:#2d2d2d !important;margin-top:5px;padding-top:10px;padding-bottom:10px;'>
                  ...
                  <div class='col-xs-2'><input id='task_index_<?php echo $count3;?>' disabled checked type='checkbox' class='Task_Checkbox' onChange='toggleTaskResolution(this)' name='Task[<?php echo $count;?>]' /></div>
                </div><?php
                continue 2;
              }
              $count2++;
            ...
            <div class='row' style='background-color:#2d2d2d !important;margin-top:5px;padding-top:10px;padding-bottom:10px;'>
              <div class='col-xs-1'><?php echo $count;?></div>
              <div class='col-xs-9 Task_Description'><?php echo trim($Task);?></div>
              <div class='col-xs-2'><input id='task_index_<?php echo $count3;?>' <?php if($Ticket['Assigned'] > 3 || $Ticket['Assigned'] == 1){?>disabled<?php }?> type='checkbox' class='Task_Checkbox' onChange='toggleTaskResolution(this)' name='Task[<?php echo $count;?>]' /></div>
            </div>
          <?php
        }
      }?>
  ...
  <?php ?>
  <script>
  $(document).ready(function(){checkBoxes('Task_Checkbox');});
  function checkTask(link){link.checked == true ? toggleContinueWork(true) : checkBoxes('Task_Checkbox').some(true) ? toggleContinueWork(true) : toggleContinueWork(false);}
  function toggleContinueWork(state = null){document.getElementById('Continue_Work').checked = state == null ? !document.getElementById('Continue_Work').checked : state;}
  ...
  <div class='panel-body' style='padding:10px;'>
    ...
    <div class='row resolution'>
      <div class='col-xs-4'><?php $Icons->Blank(1);?> Continue Work:</div>
