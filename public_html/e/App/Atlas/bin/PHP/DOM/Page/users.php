...
?><div class="panel panel-primary" style='height:100%;'>
  <div class="panel-heading"><h4><?php $Icons->Violation();?> Violations</h4></div>
  <div class='panel-body'>
    <table id='Table_Users' class='display' cellspacing='0' width='100%' style='<?php if(isMobile()){?>font-size:10px;<?php }?>color:white !important;'>
      <thead>
        <th>ID</th>
        <th>First Name</th>
        <th>Last Name</th>
...
$(document).ready(function(){
  var Table_Violations = $('#Table_Users').DataTable( {
    "ajax": {
